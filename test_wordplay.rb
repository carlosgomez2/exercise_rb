...
# Unit testingclass for the WordPlay library:
class TestWordPlay < Test::Unit::TestCase

  # Test that multipla sentence blocks are split into individual words correctly
  def test_sentences
  ...
  # Test that the correcct sentence is chosen, given the input
